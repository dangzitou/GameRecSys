        ...
        try (Scanner scanner = new Scanner(new File(movieDataPath), "UTF-8")) {
            ...
            while (scanner.hasNextLine()) {
                ...
                try {
                    ...
                    // AppID(0),Name(1),Release date(2),...,About the game(9),...,Header image(13),...,Positive(23),...,Genres(36),...,Screenshots(38),Movies(39)
                    ...
                    failCount++;
                    if (failCount <= 5) {
                        System.err.println("Error parsing line: " + fullRecord.substring(0, Math.min(fullRecord.length(), 100)) + "...");
    ...
    public List<Movie> getMoviesByGenre(String genre, int size, String sortBy){
        if (null != genre){
            ...
            switch (sortBy){
                ...
                case "positiveReviews": movies.sort((m1, m2) -> Integer.compare(m2.getPositiveReviews(), m1.getPositiveReviews()));break;
                default:
            }
